...
import com.alex.Notes_Application_BE.repositories.PasswordResetTokenRepository;
...
import com.alex.Notes_Application_BE.utils.EmailService;
...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public void updateExpiryStatus(Long userId, boolean expire) {
        User user = userRepository.findById(userId).orElseThrow(() ->
                new RuntimeException("User not found"));
    ...
    public void resetPassword(String token, String newPassword) {
        ...
        } else if (resetToken.getExpiryDate().isBefore(Instant.now())){
